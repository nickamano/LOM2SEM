...
out_train_dir_LOM = f'./mecs_steel/full/train_LOM{image_size}'
out_train_dir_SEM = f'./mecs_steel/full/train_SEM{image_size}'
out_test_dir_LOM = f'./mecs_steel/full/test_LOM{image_size}'
out_test_dir_SEM = f'./mecs_steel/full/test_SEM{image_size}'
...
for raw_img_LOM, raw_img_SEM in zip(raw_imgs_LOM, raw_imgs_SEM):
    raw_LOM = Image.open(f'./mecs_steel/LOM/{raw_img_LOM}')
    raw_SEM = Image.open(f'./mecs_steel/SEM/{raw_img_SEM}')
