...
class Palette(BaseModel):
    ...
    def train_step(self):
        ...
        if self.epoch % 10 == 1: print('epoch: ', self.epoch)
            ...
            for val_data in tqdm.tqdm(self.val_loader):
                ...
                if self.opt['distributed']:
                    ...
                    if self.task in ['inpainting','uncropping']:
                        ...
                        self.output, self.visuals = self.netG.restoration(self.cond_image, sample_num=self.sample_num, y_t=torch.randn_like(self.gt_image))
